...
Every frame:
The rocket position updates based on key presses
The rocket angle smoothly rotates toward the movement direction
Smoke particles are created when the rocket moves
Old particles fade out and are removed
Everything is redrawn on the canvas
🧩 Analogy:
...
📁 Project Structure
/project-folder │ ├── index.html # Main HTML file ├── style.css # Canvas and page styling └── script.js # Rocket logic, particles, and animation
